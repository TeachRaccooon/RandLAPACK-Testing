                            ...
                            do for [nnz in "1"] {
                                do for [runs_per_sz in "5"] {
                                    do for [OMP_threads in "36"] {
                                        ...
                                        # Show all
                                        plot fname_in u 0:1 with linespoints linestyle 1 title "CholQRCP", '' u 0:2 with linespoints linestyle 5 title "GEQP3", '' u 0:4 with linespoints linestyle 2 title "TSQRP", '' u 0:5 with linespoints linestyle 3 title "GEQRF", '' u 0:3 with linespoints linestyle 4 title "GEQR"
                                        # No GEQP3
