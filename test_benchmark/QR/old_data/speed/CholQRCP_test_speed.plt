                            ...
                            do for [nnz in "1"] {
                                do for [runs_per_sz in "5"] {
                                    do for [OMP_threads in "36"] {
                                        ...
                                        plot fname_in u 0:6 with linespoints linestyle 1 title "CholQRCP", '' u 0:9 with linespoints linestyle 2 title "TSQRP", '' u 0:8 with linespoints linestyle 3 title "GEQRF"
                                    }
                                }
                            }
                        }
